...
class EditPost extends StatelessWidget {
  static const routeName = '/edit_posting';
  ...
  Widget build(BuildContext context) {
    ...
    var id = jsonDecode(retriveString);
    ...
    Future takePicture() async {
      ...
      var uri = Uri.parse("http://localhost:8080/api/posts/edit/$id");
      ...
      notification(
          title: "Posted!!",
          body: "Your post has been edited, please check your post");
