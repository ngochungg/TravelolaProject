...
import 'package:app/widgets/user_post/image_card.dart';

import 'package:flutter/material.dart';
import 'package:http/http.dart' as http;

class UserImageCards extends StatefulWidget {
  @override
  State<UserImageCards> createState() => _UserImageCards();
}

class _UserImageCards extends State<UserImageCards> {
  List data = [];
  @override
  void initState() {
    super.initState();
    ...
    if (response.statusCode == 200) {
      ...
      var nlist = [
        for (int i = 0; i < _data.length; i++)
          if (_data[i]['user']['roles'][0]['id'] == 1) _data[i]
      ];
